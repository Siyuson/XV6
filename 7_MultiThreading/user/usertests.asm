...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	83c50513          	addi	a0,a0,-1988 # 6250 <malloc+0x804>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	7fc50513          	addi	a0,a0,2044 # 6258 <malloc+0x80c>
    ...
    exit(1);
     ...
     a7e:	7fe50513          	addi	a0,a0,2046 # 6278 <malloc+0x82c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	80a50513          	addi	a0,a0,-2038 # 62a0 <malloc+0x854>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	78e50513          	addi	a0,a0,1934 # 6250 <malloc+0x804>
     ...
     af2:	7d250513          	addi	a0,a0,2002 # 62c0 <malloc+0x874>
     ...
     b10:	7dc50513          	addi	a0,a0,2012 # 62e8 <malloc+0x89c>
     ...
     b2e:	7d650513          	addi	a0,a0,2006 # 6300 <malloc+0x8b4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	7e250513          	addi	a0,a0,2018 # 6328 <malloc+0x8dc>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	11c50513          	addi	a0,a0,284 # 5c90 <malloc+0x244>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	7d458593          	addi	a1,a1,2004 # 6360 <malloc+0x914>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	0e850513          	addi	a0,a0,232 # 5c90 <malloc+0x244>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	0d250513          	addi	a0,a0,210 # 5c90 <malloc+0x244>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	0bc50513          	addi	a0,a0,188 # 5c90 <malloc+0x244>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	7c058593          	addi	a1,a1,1984 # 63a8 <malloc+0x95c>
  ...
  unlink("unlinkread");
     ...
     c54:	04050513          	addi	a0,a0,64 # 5c90 <malloc+0x244>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	6d050513          	addi	a0,a0,1744 # 6340 <malloc+0x8f4>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	6dc50513          	addi	a0,a0,1756 # 6368 <malloc+0x91c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	6e050513          	addi	a0,a0,1760 # 6388 <malloc+0x93c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	6ec50513          	addi	a0,a0,1772 # 63b0 <malloc+0x964>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	6f050513          	addi	a0,a0,1776 # 63d0 <malloc+0x984>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	6f450513          	addi	a0,a0,1780 # 63f0 <malloc+0x9a4>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	60058593          	addi	a1,a1,1536 # 6360 <malloc+0x914>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	69858593          	addi	a1,a1,1688 # 6418 <malloc+0x9cc>
     d88:	00005517          	auipc	a0,0x5
     d8c:	68850513          	addi	a0,a0,1672 # 6410 <malloc+0x9c4>
  ...
  unlink("lf1");
     ...
     da0:	67450513          	addi	a0,a0,1652 # 6410 <malloc+0x9c4>
     da4:	00005097          	auipc	ra,0x5
     da8:	8c2080e7          	jalr	-1854(ra) # 5666 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	66250513          	addi	a0,a0,1634 # 6410 <malloc+0x9c4>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	65450513          	addi	a0,a0,1620 # 6418 <malloc+0x9cc>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	61c58593          	addi	a1,a1,1564 # 6418 <malloc+0x9cc>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	60650513          	addi	a0,a0,1542 # 6418 <malloc+0x9cc>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	84c080e7          	jalr	-1972(ra) # 5666 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	5ee58593          	addi	a1,a1,1518 # 6410 <malloc+0x9c4>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	5ee50513          	addi	a0,a0,1518 # 6418 <malloc+0x9cc>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	5d258593          	addi	a1,a1,1490 # 6410 <malloc+0x9c4>
     e46:	00005517          	auipc	a0,0x5
     e4a:	6da50513          	addi	a0,a0,1754 # 6520 <malloc+0xad4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	5b850513          	addi	a0,a0,1464 # 6420 <malloc+0x9d4>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	5b450513          	addi	a0,a0,1460 # 6438 <malloc+0x9ec>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	5b050513          	addi	a0,a0,1456 # 6450 <malloc+0xa04>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	5b450513          	addi	a0,a0,1460 # 6470 <malloc+0xa24>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	5c850513          	addi	a0,a0,1480 # 64a0 <malloc+0xa54>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	5c450513          	addi	a0,a0,1476 # 64b8 <malloc+0xa6c>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	5c050513          	addi	a0,a0,1472 # 64d0 <malloc+0xa84>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	5cc50513          	addi	a0,a0,1484 # 64f8 <malloc+0xaac>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	5e050513          	addi	a0,a0,1504 # 6528 <malloc+0xadc>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	59aa0a13          	addi	s4,s4,1434 # 6548 <malloc+0xafc>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	54850513          	addi	a0,a0,1352 # 6548 <malloc+0xafc>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	4e050513          	addi	a0,a0,1248 # 6550 <malloc+0xb04>
    ...
    1094:	4e050513          	addi	a0,a0,1248 # 6570 <malloc+0xb24>
    ...
    10b0:	4e450513          	addi	a0,a0,1252 # 6590 <malloc+0xb44>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	4d298993          	addi	s3,s3,1234 # 65b0 <malloc+0xb64>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	4a650513          	addi	a0,a0,1190 # 65c0 <malloc+0xb74>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	d0298993          	addi	s3,s3,-766 # 5e88 <malloc+0x43c>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	58078793          	addi	a5,a5,1408 # 7790 <malloc+0x1d44>
  ...
  if(pid == 0){
    ...
    124a:	14278793          	addi	a5,a5,322 # 8388 <big.1264>
    ...
    1270:	c1478793          	addi	a5,a5,-1004 # 7e80 <malloc+0x2434>
    ...
    1294:	bf850513          	addi	a0,a0,-1032 # 5e88 <malloc+0x43c>
    ...
    12ac:	3c050513          	addi	a0,a0,960 # 6668 <malloc+0xc1c>
    ...
    12cc:	31850513          	addi	a0,a0,792 # 65e0 <malloc+0xb94>
    ...
    12ec:	31850513          	addi	a0,a0,792 # 6600 <malloc+0xbb4>
    ...
    130e:	31650513          	addi	a0,a0,790 # 6620 <malloc+0xbd4>
    ...
    132e:	31e50513          	addi	a0,a0,798 # 6648 <malloc+0xbfc>
    ...
    1348:	78450513          	addi	a0,a0,1924 # 6ac8 <malloc+0x107c>
  ...
  if(st != 747){
    ...
    1392:	30250513          	addi	a0,a0,770 # 6690 <malloc+0xc44>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	b2050513          	addi	a0,a0,-1248 # 5ee0 <malloc+0x494>
  ...
  if(pid == 0){
    ...
    13ee:	af6a0a13          	addi	s4,s4,-1290 # 5ee0 <malloc+0x494>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	2fea8a93          	addi	s5,s5,766 # 66f0 <malloc+0xca4>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	25e50513          	addi	a0,a0,606 # 66c0 <malloc+0xc74>
    ...
    1482:	25a50513          	addi	a0,a0,602 # 66d8 <malloc+0xc8c>
    ...
    14a0:	26450513          	addi	a0,a0,612 # 6700 <malloc+0xcb4>
    ...
    14be:	a26a0a13          	addi	s4,s4,-1498 # 5ee0 <malloc+0x494>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	25ea8a93          	addi	s5,s5,606 # 6720 <malloc+0xcd4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	9d450513          	addi	a0,a0,-1580 # 5ee0 <malloc+0x494>
  ...
  exit(xstatus);
    ...
    152e:	1ae50513          	addi	a0,a0,430 # 66d8 <malloc+0xc8c>
    ...
    154c:	1e050513          	addi	a0,a0,480 # 6728 <malloc+0xcdc>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	91878793          	addi	a5,a5,-1768 # 5e88 <malloc+0x43c>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	1cc78793          	addi	a5,a5,460 # 6748 <malloc+0xcfc>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	1c450513          	addi	a0,a0,452 # 6750 <malloc+0xd04>
  ...
  if(pid == 0) {
    ...
    15be:	19650513          	addi	a0,a0,406 # 6750 <malloc+0xd04>
    ...
    15da:	19a50513          	addi	a0,a0,410 # 6770 <malloc+0xd24>
    ...
    15f6:	0ce50513          	addi	a0,a0,206 # 66c0 <malloc+0xc74>
    ...
    1612:	14a50513          	addi	a0,a0,330 # 6758 <malloc+0xd0c>
    ...
    1630:	85c50513          	addi	a0,a0,-1956 # 5e88 <malloc+0x43c>
  ...
  if(xstatus != 0)
    ...
    1664:	12050513          	addi	a0,a0,288 # 6780 <malloc+0xd34>
    ...
    1680:	11c50513          	addi	a0,a0,284 # 6798 <malloc+0xd4c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	0c050513          	addi	a0,a0,192 # 6750 <malloc+0xd04>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	b5e50513          	addi	a0,a0,-1186 # 6218 <malloc+0x7cc>
    ...
    16da:	00250513          	addi	a0,a0,2 # 66d8 <malloc+0xc8c>
  ...
  unlink("echo-ok");
    ...
    16f4:	06050513          	addi	a0,a0,96 # 6750 <malloc+0xd04>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	09650513          	addi	a0,a0,150 # 67b0 <malloc+0xd64>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	fec50513          	addi	a0,a0,-20 # 67c8 <malloc+0xd7c>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	f7e50513          	addi	a0,a0,-130 # 67e0 <malloc+0xd94>
    ...
    1882:	f7a50513          	addi	a0,a0,-134 # 67f8 <malloc+0xdac>
    ...
    18b4:	f6050513          	addi	a0,a0,-160 # 6810 <malloc+0xdc4>
    ...
    18f4:	f4050513          	addi	a0,a0,-192 # 6830 <malloc+0xde4>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	d5e50513          	addi	a0,a0,-674 # 66c0 <malloc+0xc74>
    ...
    1982:	eca50513          	addi	a0,a0,-310 # 6848 <malloc+0xdfc>
    ...
    199e:	ec650513          	addi	a0,a0,-314 # 6860 <malloc+0xe14>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	cae50513          	addi	a0,a0,-850 # 66c0 <malloc+0xc74>
    ...
    1a3a:	c8a50513          	addi	a0,a0,-886 # 66c0 <malloc+0xc74>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	dd050513          	addi	a0,a0,-560 # 6880 <malloc+0xe34>
    ...
    1ac6:	b54080e7          	jalr	-1196(ra) # 5616 <exit>
{
    ...
    1b0c:	d8850513          	addi	a0,a0,-632 # 6890 <malloc+0xe44>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	f7250513          	addi	a0,a0,-142 # 6ac8 <malloc+0x107c>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	ed450513          	addi	a0,a0,-300 # 6ac8 <malloc+0x107c>
    ...
    1c24:	b3850513          	addi	a0,a0,-1224 # 6758 <malloc+0xd0c>
    ...
    1c96:	c1e50513          	addi	a0,a0,-994 # 68b0 <malloc+0xe64>
    ...
    1cca:	c0250513          	addi	a0,a0,-1022 # 68c8 <malloc+0xe7c>
    ...
    1d30:	bc450513          	addi	a0,a0,-1084 # 68f0 <malloc+0xea4>
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	12c50513          	addi	a0,a0,300 # 5ef8 <malloc+0x4ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	0f0a8a93          	addi	s5,s5,240 # 5ef8 <malloc+0x4ac>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	b08b8b93          	addi	s7,s7,-1272 # 6918 <malloc+0xecc>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	8a450513          	addi	a0,a0,-1884 # 66c0 <malloc+0xc74>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	bbe50513          	addi	a0,a0,-1090 # 6ac8 <malloc+0x107c>
    ...
    1f4a:	b5ab8b93          	addi	s7,s7,-1190 # baa0 <buf>
    ...
    1fbe:	96650513          	addi	a0,a0,-1690 # 6920 <malloc+0xed4>
    ...
    1fde:	f6e50513          	addi	a0,a0,-146 # 5f48 <malloc+0x4fc>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	92850513          	addi	a0,a0,-1752 # 6950 <malloc+0xf04>
  ...
  if(wait(0) != -1){
    ...
    208e:	8ae50513          	addi	a0,a0,-1874 # 6938 <malloc+0xeec>
    ...
    20aa:	8d250513          	addi	a0,a0,-1838 # 6978 <malloc+0xf2c>
    ...
    20c6:	8ce50513          	addi	a0,a0,-1842 # 6990 <malloc+0xf44>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	57e50513          	addi	a0,a0,1406 # 66c0 <malloc+0xc74>
    ...
    2168:	84450513          	addi	a0,a0,-1980 # 69a8 <malloc+0xf5c>
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	83450513          	addi	a0,a0,-1996 # 69c8 <malloc+0xf7c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	80250513          	addi	a0,a0,-2046 # 69c8 <malloc+0xf7c>
  ...
  close(fd);
    ...
    21f0:	09c78793          	addi	a5,a5,156 # 8288 <args.1834>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	18c68693          	addi	a3,a3,396 # 8380 <args.1834+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00004717          	auipc	a4,0x4
    2200:	7dc70713          	addi	a4,a4,2012 # 69d8 <malloc+0xf8c>
    ...
    2254:	86850513          	addi	a0,a0,-1944 # 6ab8 <malloc+0x106c>
    ...
    2278:	86450513          	addi	a0,a0,-1948 # 6ad8 <malloc+0x108c>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22d6:	82650513          	addi	a0,a0,-2010 # 6af8 <malloc+0x10ac>
    ...
    22f2:	3d250513          	addi	a0,a0,978 # 66c0 <malloc+0xc74>
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	40878793          	addi	a5,a5,1032 # 7790 <malloc+0x1d44>
  ...
  if(ret != -1){
    ...
    23ce:	75650513          	addi	a0,a0,1878 # 6b20 <malloc+0x10d4>
    ...
    23ec:	1f850513          	addi	a0,a0,504 # 65e0 <malloc+0xb94>
    ...
    240a:	1fa50513          	addi	a0,a0,506 # 6600 <malloc+0xbb4>
    ...
    242a:	1fa50513          	addi	a0,a0,506 # 6620 <malloc+0xbd4>
    ...
    2448:	20450513          	addi	a0,a0,516 # 6648 <malloc+0xbfc>
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	71850513          	addi	a0,a0,1816 # 5ba8 <malloc+0x15c>
  ...
  if(n >= 0){
    ...
    24c6:	6b650513          	addi	a0,a0,1718 # 6b78 <malloc+0x112c>
    ...
    24e0:	64c50513          	addi	a0,a0,1612 # 6b28 <malloc+0x10dc>
    ...
    24fa:	64a50513          	addi	a0,a0,1610 # 6b40 <malloc+0x10f4>
    ...
    2514:	65050513          	addi	a0,a0,1616 # 6b60 <malloc+0x1114>
  ...
  unlink("rwsbrk");
    ...
    2538:	67450513          	addi	a0,a0,1652 # 5ba8 <malloc+0x15c>
    253c:	00003097          	auipc	ra,0x3
    2540:	12a080e7          	jalr	298(ra) # 5666 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	ada50513          	addi	a0,a0,-1318 # 6020 <malloc+0x5d4>
  ...
  if(n >= 0){
    ...
    2574:	63850513          	addi	a0,a0,1592 # 6ba8 <malloc+0x115c>
    ...
    258e:	5d650513          	addi	a0,a0,1494 # 6b60 <malloc+0x1114>
...
00000000000025b8 <sbrkbasic>:
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2664:	59050513          	addi	a0,a0,1424 # 6bf0 <malloc+0x11a4>
...
0000000000004078 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    40e4:	e1858593          	addi	a1,a1,-488 # 5ef8 <malloc+0x4ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    41a8:	7d450513          	addi	a0,a0,2004 # 7978 <malloc+0x1f2c>
    ...
    41c4:	50050513          	addi	a0,a0,1280 # 66c0 <malloc+0xc74>
    ...
    4210:	78c50513          	addi	a0,a0,1932 # 7998 <malloc+0x1f4c>
...
0000000000004230 <reparent>:
{
  ...
  exit(0);
    ...
    4284:	44050513          	addi	a0,a0,1088 # 66c0 <malloc+0xc74>
    ...
    42a0:	5ac50513          	addi	a0,a0,1452 # 6848 <malloc+0xdfc>
...
00000000000042e0 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4348:	68450513          	addi	a0,a0,1668 # 79c8 <malloc+0x1f7c>
...
0000000000004386 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    441c:	5d050513          	addi	a0,a0,1488 # 79e8 <malloc+0x1f9c>
    ...
    4438:	5dc50513          	addi	a0,a0,1500 # 7a10 <malloc+0x1fc4>
  ...
  fd = open("sharedfd", 0);
    ...
    447c:	85050513          	addi	a0,a0,-1968 # 5cc8 <malloc+0x27c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    44bc:	57850513          	addi	a0,a0,1400 # 7a30 <malloc+0x1fe4>
    ...
    44d6:	fd2783e3          	beq	a5,s2,449c <sharedfd+0x116>
      if(buf[i] == 'c')
    44da:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1550>
  ...
  unlink("sharedfd");
    44f4:	00001517          	auipc	a0,0x1
    44f8:	7d450513          	addi	a0,a0,2004 # 5cc8 <malloc+0x27c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    451e:	53e50513          	addi	a0,a0,1342 # 7a58 <malloc+0x200c>
...
000000000000453e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4562:	5d278793          	addi	a5,a5,1490 # 5b30 <malloc+0xe4>
    4566:	f6f43823          	sd	a5,-144(s0)
    456a:	00001797          	auipc	a5,0x1
    456e:	5ce78793          	addi	a5,a5,1486 # 5b38 <malloc+0xec>
    4572:	f6f43c23          	sd	a5,-136(s0)
    4576:	00001797          	auipc	a5,0x1
    457a:	5ca78793          	addi	a5,a5,1482 # 5b40 <malloc+0xf4>
    457e:	f8f43023          	sd	a5,-128(s0)
    4582:	00001797          	auipc	a5,0x1
    4586:	5c678793          	addi	a5,a5,1478 # 5b48 <malloc+0xfc>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    45e0:	4c4a0a13          	addi	s4,s4,1220 # baa0 <buf>
    45e4:	00007a97          	auipc	s5,0x7
    45e8:	4bda8a93          	addi	s5,s5,1213 # baa1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    45fe:	4ce50513          	addi	a0,a0,1230 # 6ac8 <malloc+0x107c>
    ...
    46b6:	3e650513          	addi	a0,a0,998 # 7a98 <malloc+0x204c>
    ...
    46e6:	3be78793          	addi	a5,a5,958 # baa0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4746:	36650513          	addi	a0,a0,870 # 7aa8 <malloc+0x205c>
...
000000000000477a <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47a8:	31cb8b93          	addi	s7,s7,796 # 7ac0 <malloc+0x2074>
  for(i = 0; i < N; i++){
    ...
    47ea:	2e250513          	addi	a0,a0,738 # 7ac8 <malloc+0x207c>
    ...
    4808:	2bc50513          	addi	a0,a0,700 # 7ac0 <malloc+0x2074>
  ...
  fd = open(".", 0);
    ...
    4840:	ce450513          	addi	a0,a0,-796 # 6520 <malloc+0xad4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4866:	28650513          	addi	a0,a0,646 # 7ae8 <malloc+0x209c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    48d6:	23650513          	addi	a0,a0,566 # 7b08 <malloc+0x20bc>
  ...
  for(i = 0; i < N; i++){
    ...
    490e:	22650513          	addi	a0,a0,550 # 7b30 <malloc+0x20e4>
    ...
    492a:	d9a50513          	addi	a0,a0,-614 # 66c0 <malloc+0xc74>
...
0000000000004ad4 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4b5c:	01050513          	addi	a0,a0,16 # 7b68 <malloc+0x211c>
  ...
  for(i = 0; ; i++){
    ...
    4bc0:	fbc50513          	addi	a0,a0,-68 # 7b78 <malloc+0x212c>
    ...
    4bdc:	fc050513          	addi	a0,a0,-64 # 7b98 <malloc+0x214c>
    ...
    4bf8:	fc450513          	addi	a0,a0,-60 # 7bb8 <malloc+0x216c>
    ...
    4c14:	fc850513          	addi	a0,a0,-56 # 7bd8 <malloc+0x218c>
    ...
    4c30:	fcc50513          	addi	a0,a0,-52 # 7bf8 <malloc+0x21ac>
    ...
    4c4c:	fc850513          	addi	a0,a0,-56 # 7c10 <malloc+0x21c4>
  ...
  unlink("bigfile.dat");
    ...
    4c7a:	ef250513          	addi	a0,a0,-270 # 7b68 <malloc+0x211c>
    ...
    4c9e:	f9650513          	addi	a0,a0,-106 # 7c30 <malloc+0x21e4>
...
0000000000004cb4 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4cd6:	f7e50513          	addi	a0,a0,-130 # 7c50 <malloc+0x2204>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4cf6:	f6ec8c93          	addi	s9,s9,-146 # 7c60 <malloc+0x2214>
    int total = 0;
    4cfa:	4d81                	li	s11,0
    ...
    4d70:	f0450513          	addi	a0,a0,-252 # 7c70 <malloc+0x2224>
  ...
  printf("fsfull test finished\n");
    ...
    4de6:	eae50513          	addi	a0,a0,-338 # 7c90 <malloc+0x2244>
    ...
    4e36:	e4e50513          	addi	a0,a0,-434 # 7c80 <malloc+0x2234>
...
0000000000004e84 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4ef8:	db450513          	addi	a0,a0,-588 # 7ca8 <malloc+0x225c>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4f10:	fec58593          	addi	a1,a1,-20 # 5ef8 <malloc+0x4ac>
    ...
    4f26:	da650513          	addi	a0,a0,-602 # 7cc8 <malloc+0x227c>
    ...
    4f40:	d7450513          	addi	a0,a0,-652 # 7cb0 <malloc+0x2264>
    ...
    4f5a:	d5a50513          	addi	a0,a0,-678 # 7cb0 <malloc+0x2264>
  ...
  unlink("junk");
    ...
    4f7e:	d2e50513          	addi	a0,a0,-722 # 7ca8 <malloc+0x225c>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4fd4:	f2890913          	addi	s2,s2,-216 # 5ef8 <malloc+0x4ac>
      uint64 a = (uint64) sbrk(4096);
