...
go(int which_child)
{
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1234+0xeb>
    ...
    if(what == 1){
     ...
     292:	35258593          	addi	a1,a1,850 # 15e0 <malloc+0x344>
     ...
     2b6:	38650513          	addi	a0,a0,902 # 1638 <malloc+0x39c>
     ...
     396:	2fe58593          	addi	a1,a1,766 # 1690 <buf.1234>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2e658593          	addi	a1,a1,742 # 1690 <buf.1234>
     3b2:	854a                	mv	a0,s2
     ...
     670:	e5450513          	addi	a0,a0,-428 # 14c0 <malloc+0x224>
     ...
     69c:	e4058593          	addi	a1,a1,-448 # 14d8 <malloc+0x23c>
     ...
     774:	d6850513          	addi	a0,a0,-664 # 14d8 <malloc+0x23c>
     778:	00000097          	auipc	ra,0x0
     77c:	726080e7          	jalr	1830(ra) # e9e <open>
        unlink("x");
     780:	00001517          	auipc	a0,0x1
     784:	d5850513          	addi	a0,a0,-680 # 14d8 <malloc+0x23c>
     ...
     79e:	ce650513          	addi	a0,a0,-794 # 1480 <malloc+0x1e4>
     ...
     7e4:	cf858593          	addi	a1,a1,-776 # 14d8 <malloc+0x23c>
     ...
     88c:	ce850513          	addi	a0,a0,-792 # 1570 <malloc+0x2d4>
     ...
     8a6:	cf650513          	addi	a0,a0,-778 # 1598 <malloc+0x2fc>
     ...
     8c0:	c0458593          	addi	a1,a1,-1020 # 14c0 <malloc+0x224>
     8c4:	4509                	li	a0,2
     ...
     8dc:	be858593          	addi	a1,a1,-1048 # 14c0 <malloc+0x224>
     8e0:	4509                	li	a0,2
     ...
     9ac:	ad858593          	addi	a1,a1,-1320 # 1480 <malloc+0x1e4>
     9b0:	4509                	li	a0,2
     ...
     aa4:	9e058593          	addi	a1,a1,-1568 # 1480 <malloc+0x1e4>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     afe:	b8f73323          	sd	a5,-1146(a4) # 1680 <rand_next>
    go(0);
     b02:	4501                	li	a0,0
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b36:	6789                	lui	a5,0x2
     b38:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0x181>
     b3c:	00001717          	auipc	a4,0x1
     b40:	b4f73223          	sd	a5,-1212(a4) # 1680 <rand_next>
    go(1);
     b44:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f4e:	71e50513          	addi	a0,a0,1822 # 1668 <digits>
     f52:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    101a:	652b8b93          	addi	s7,s7,1618 # 1668 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    115a:	50a90913          	addi	s2,s2,1290 # 1660 <malloc+0x3c4>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1222:	46a7b783          	ld	a5,1130(a5) # 1688 <freep>
    ...
    1250:	00e6ea63          	bltu	a3,a4,1264 <free+0x50>
{
  ...
  freep = p;
    ...
    1292:	3ef73d23          	sd	a5,1018(a4) # 1688 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12c4:	3c853503          	ld	a0,968(a0) # 1688 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12ec:	3a090913          	addi	s2,s2,928 # 1688 <freep>
  if(p == (char*)-1)
    12f0:	5afd                	li	s5,-1
    12f2:	a88d                	j	1364 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12f4:	00000797          	auipc	a5,0x0
    12f8:	78478793          	addi	a5,a5,1924 # 1a78 <base>
    12fc:	00000717          	auipc	a4,0x0
    1300:	38f73623          	sd	a5,908(a4) # 1688 <freep>
    ...
    1326:	36a73323          	sd	a0,870(a4) # 1688 <freep>
      return (void*)(p + 1);
